...
// Validate ../../src/app/api/parking-spaces/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/parking-spaces">> = Specific
  const handler = {} as typeof import("../../src/app/api/parking-spaces/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
